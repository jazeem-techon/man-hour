import { Employee, Project, Salesperson, ManHour, Leave } from '../types';
...
export const projects: Project[] = [
  { _id: 'p1', name: 'Abu Dhabi Metro Expansion', salespersonId: 's1', isActive: true, createdAt: '2024-01-20' },
  { _id: 'p2', name: 'ADNOC Digital Infrastructure', salespersonId: 's2', isActive: true, createdAt: '2024-02-05' },
  { _id: 'p3', name: 'Dubai Mall ELV System', salespersonId: 's1', isActive: true, createdAt: '2024-02-15' },
  { _id: 'p4', name: 'Etihad HQ Retrofit', salespersonId: 's3', isActive: false, createdAt: '2024-03-01' },
]

export const manHours: ManHour[] = [
